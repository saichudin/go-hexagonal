...
func post(url string, body io.Reader, headers http.Header, timeout time.Duration) (*http.Response, error) {
	...
	if err != nil {
		return response, errors.New("POST - request creation failed")
	}
...
func put(url string, body io.Reader, headers http.Header, timeout time.Duration) (*http.Response, error) {
	...
	if err != nil {
		return response, errors.New("PUT - request creation failed")
	}
...
func patch(url string, body io.Reader, headers http.Header, timeout time.Duration) (*http.Response, error) {
	...
	if err != nil {
		return response, errors.New("PATCH - request creation failed")
	}
...
func delete(url string, body io.Reader, headers http.Header, timeout time.Duration) (*http.Response, error) {
	var response *http.Response
	request, err := http.NewRequest(http.MethodDelete, url, body)
	if err != nil {
		return response, errors.New("DELETE - request creation failed")
	}
